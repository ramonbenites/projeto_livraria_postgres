...
class LivroService:
    ...
    def __init__(self, categoria_dao: CategoriaDAO, editora_dao: EditoraDAO, autor_dao: AutorDAO):
        self.__livro_dao: LivroDAO = LivroDAO(
            categoria_dao, editora_dao, autor_dao)
    ...
    def listar(self):
        ...
        try:
            ...
            for livro in livros:
                print(f'Id: {livro.id} | Título: {livro.titulo} | Resumo: {livro.resumo} | Ano: {str(livro.ano)} | Páginas: {str(livro.paginas)} | Isbn: {
                      livro.isbn} | Categoria: {livro.categoria.nome} | Editora: {livro.editora.nome}  | Autor: {livro.autor.nome}')
    ...
    def adicionar(self):
        ...
        try:
            ...
            while (categoria == None):
                ...
                id_categoria = int(
                    input('Digite o ID da categoria do livro: '))
                categoria: Categoria = self.__categoria_dao.buscar_por_id(
                    id_categoria)
    ...
    def mostrar_por_id(self):
        ...
        try:
            ...
            if (liv == None):
                ...
                print(f'Id: {liv.id} | Título: {liv.titulo} | Resumo: {liv.resumo} | Ano: {str(liv.ano)} | Páginas: {str(liv.paginas)} | Isbn: {
                      liv.isbn} | Categoria: {liv.categoria.nome}  | Editora: {liv.editora.nome}  | Autor: {liv.autor.nome}')
        except Exception as e:
